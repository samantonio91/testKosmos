module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      // xl: '0 .5rem 1rem rgba(0,0,0,0.15)',
      xl: 'rgb(0 0 0 / 20%) 0px 3px 3px -2px, rgb(0, 0, 0, 0.20) 0px 3px 4px 0px, rgb(0, 0, 0, 0.20) 0px 1px 8px 0px',
      inner: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)',
      none: 'none',
      custom1: '0px 32px 34px rgba(0, 0, 0, 0.133714)',
    },
    container: {
